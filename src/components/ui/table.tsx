...
const TableFooter = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLTableSectionElement>
>(({ className, ...props }, ref) => (
  <tfoot ref={ref} className={cn("border-t border-white/10 bg-[#1C1C1E] font-medium [&>tr]:last:border-b-0", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr ref={ref} className={cn("border-b border-white/5 transition-colors hover:bg-white/5 data-[state=selected]:bg-white/5", className)} {...props} />
))
