  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: "bg-[#D4A853] text-[#0A0A0B] hover:bg-[#D4A853] hover:text-[#0A0A0B] focus:bg-[#D4A853] focus:text-[#0A0A0B]",
        day_today: "bg-white/10 text-white",
        day_outside: "day-outside text-gray-600 opacity-50 aria-selected:bg-white/5 aria-selected:text-gray-400 aria-selected:opacity-30",
